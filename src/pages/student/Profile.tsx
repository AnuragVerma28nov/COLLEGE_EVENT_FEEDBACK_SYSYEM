...
import { User, Mail, Key, School } from 'lucide-react';
...
const StudentProfile: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    name: user?.name || '',
    email: user?.email || '',
    studentId: 'S12345', // Mock student ID
    department: 'Computer Science', // Mock department
    year: '3rd Year', // Mock year
    currentPassword: '',
    newPassword: '',
    confirmPassword: '',
  });
              ...
              {isEditing ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium text-gray-500 w-24">Student ID:</span>
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-gray-900">{formData.year}</span>
                  </div>
                  <div className="pt-4">
                    <button
                      type="button"
